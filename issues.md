...
- [x] **23. Comments in Node Mode:** No way to add comments; they shouldn't be standard nodes, and their order preservation needs a different mechanism than Cell mode
- [x] **24. Overall Formatting Dropdown:** Appears behind nodes instead of pushing the canvas down; needs the same logic rework as the cell formatting menu
